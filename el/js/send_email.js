...
function submit_email(){
    ...
    if(name_input.value === "" && div_below_name[0].children.length === 0){
        ...
        var node_name = document.createTextNode("Αυτό το πεδίο είναι απαραίτητο");
    ...
    if (email_input.value === "" && div_below_email[0].children.length === 0){
        ...
        var node_email = document.createTextNode("Αυτό το πεδίο είναι απαραίτητο");
    ...
    if(message_input.value === "" && div_below_message[0].children.length === 0){
        ...
        var node_message = document.createTextNode("Αυτό το πεδίο είναι απαραίτητο");
        ...
        var user_fault_email = document.createElement("div");
        var node_email = document.createTextNode("Το email είναι σε λάθος μορφή");
        user_fault_email.className = "a_alert_content";
        user_fault_email.appendChild(node_email);
        div_below_email[0].appendChild(user_fault_email);
    }
        ...
        Swal.fire({
            title: 'Είσαι σίγουρος ότι θες να στείλεις email χωρίς θέμα?',
            showDenyButton: true,
